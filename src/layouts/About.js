      ...
      <div className="about-details">
        ...
        <div className="about-intro">
          ...
          <p>
            ...
            I work extensivelywith Angular, React, and TypeScript, navigating
            the world of frontend development. <br />
            My aim is to create code that emphasizinguser-friendly interfaces
            blending striking design with inclusivity for all. <br />I hold a
            bachelor's degree in Biomedical Engineering from Cairo University in
            Egypt. I'm actively seeking opportunities where I can contribute,
            learn, and grow. If you have an exciting opportunity that aligns
            with my skills and experiences, I'm eager to connect.
          </p>
        </div>
        {/* </Zoom> */}
        ...
        <div className="about-skills">
          ...
          <div className="skill-div">
            <img src={require("../assests/html-icon.ico")} alt="html-icon" />
            <p class="">
              <b>HTML</b>
            </p>
          </div>
          ...
          <div className="skill-div">
            <img src={require("../assests/sass-icon.ico")} alt="sass-icon" />
            <p>
              <b>SASS</b>
            </p>
          </div>
          ...
          <div className="skill-div">
            <img src={require("../assests/react-icon.ico")} alt="react-icon" />
            <p>
              <b>REACT</b>
            </p>
          </div>
          ...
          <div className="skill-div">
            <img src={require("../assests/mysql-icon.ico")} alt="mysql-icon" />
            <p>
              <b>SQL BASICS</b>
            </p>
          </div>
